...
insert into movies (movie_id, name, genre, year, duration, synopsis) values
    (0, 'Iron Man', 'Action', 2008, 126, '...'),
    (0, 'Avengers', 'Action', 2012, 160, '...'),
    (0, 'Batman vs Superman', 'Action', 2016, 183, '...'),
    (0, 'Ant Man', 'Action',  2015, 118, '...');
